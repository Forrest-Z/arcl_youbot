...
#include <arcl_youbot_msgs/MoveBaseAction.h>
#include <arcl_youbot_msgs/AlignBaseToPoseAction.h>
...
#include <arcl_youbot_msgs/ApproachBaseAction.h>
#include <arcl_youbot_msgs/GetBasePose.h>

class ModuleBaseController : public ControllerModule
{
public:

    typedef actionlib::SimpleActionServer<arcl_youbot_msgs::MoveBaseAction> MoveBaseServer;
    typedef actionlib::SimpleActionServer<arcl_youbot_msgs::AlignBaseToPoseAction> AlignBaseServer;
    typedef actionlib::SimpleActionServer<arcl_youbot_msgs::ApproachBaseAction> ApproachServer;
    typedef arcl_youbot_msgs::MoveBaseGoal BasePose;
    typedef arcl_youbot_msgs::AlignBaseToPoseGoal AlignGoal;
    typedef arcl_youbot_msgs::ApproachBaseGoal ApproachGoal;
