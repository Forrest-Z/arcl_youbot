...
class HSVColorRangeDetector:
    ...
    def _init_trackbars(self):
        ...
        # HSV Lower Bound
        h_min_trackbar = _Trackbar("H min", trackbars_window_name, 0, 179)
        s_min_trackbar = _Trackbar("S min", trackbars_window_name, 0, 255)
        v_min_trackbar = _Trackbar("V min", trackbars_window_name, 0, 255)

        # HSV Upper Bound
        h_max_trackbar = _Trackbar("H max", trackbars_window_name, 179, 179)
    ...
    def detect(self, display_width = 360, display_height = 240):
