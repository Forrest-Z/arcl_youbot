...
def random_colors(nb_of_colors, brightness = 1.0):
...
def draw_tracker_points(points, debug_image, color = (255, 255, 255)):
...
def draw_debug_frame_for_object(debug_frame, tracked_object, color = (255, 255, 255)):
