...
class ColorTracker(object):
    def __init__(self, max_nb_of_objects= None,
                 max_nb_of_points= None, debug= True):
        """
    ...
    @staticmethod
    def _read_from_camera(camera, horizontal_flip):
    ...
    def track(self, camera, hsv_lower_value,
              hsv_upper_value, min_contour_area = 0,
              kernel = None, horizontal_flip = True, max_track_point_distance = 100,
              max_skipped_frames = 24):
        """
