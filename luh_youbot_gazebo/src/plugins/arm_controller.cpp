...
//           arm_joints_[4]->SetAngle(0, math::Angle(cmd_.q5));
            arm_joints_[0]->SetPosition(0, cmd_.q1, true);
            arm_joints_[1]->SetPosition(0, cmd_.q2, true);
            arm_joints_[2]->SetPosition(0, cmd_.q3, true);
            arm_joints_[3]->SetPosition(0, cmd_.q4, true);
