...
{    
    ...
    else
    {
        ...
        //                node_->advertise<arcl_youbot_msgs::JointVector>("motion_planner/position_error", 100);
...
void ModuleMotionPlanner::update()
{
    ...
    //    arcl_youbot_msgs::JointVector err_msg;
    //    err_msg.q1 = err.q1();
    //    err_msg.q2 = err.q2();
    //    err_msg.q3 = err.q3();
    //    err_msg.q4 = err.q4();
...
{
    arcl_youbot_kinematics::JointPosition end_pose = end_pose_;
    //end_pose.addOffset();
    arcl_youbot_kinematics::JointPosition goal_pose = youbot_->arm()->getJointPosition();
    arcl_youbot_kinematics::JointVelocity velocity = youbot_->arm()->getJointVelocity();
    arcl_youbot_kinematics::JointPosition pose_diff = (goal_pose - end_pose).abs();
