...
bool ModuleMotionPlanner::predefPoseCallback(arcl_youbot_msgs::ToPredefinedPose::Request &req,
...
//############### CALLBACK: LIST POSES #################################################################################
bool ModuleMotionPlanner::listPosesCallback(arcl_youbot_msgs::ListPoses::Request &req,
                                            arcl_youbot_msgs::ListPoses::Response &res)
{
    boost::mutex::scoped_lock lock(arm_mutex_);
...
void ModuleMotionPlanner::jointPathCallback()
{
    ...
    // === GET GOAL ===
    boost::shared_ptr<const arcl_youbot_msgs::MoveJointPathGoal> goal = joint_path_server_->acceptNewGoal();
...
void ModuleMotionPlanner::cartesianPathCallback()
{
    ...
    // === GET GOAL ===
    boost::shared_ptr<const arcl_youbot_msgs::MoveCartesianPathGoal> goal
...
void ModuleMotionPlanner::cylindricPathCallback()
{
    ...
    // === GET GOAL ===
    boost::shared_ptr<const arcl_youbot_msgs::MoveCylindricPathGoal> goal
...
void ModuleMotionPlanner::namedPathCallback()
{
    ...
    // === GET GOAL ===
    boost::shared_ptr<const arcl_youbot_msgs::MoveNamedPathGoal> goal = named_path_server_->acceptNewGoal();
