...
void ModuleDirectControl::preempt()
{
    ...
    if(preempted)
    {
        arcl_youbot_kinematics::JointPosition current_pos = youbot_->arm()->getJointPosition();
...
bool ModuleDirectControl::relaxCallback(std_srvs::Empty::Request &req, std_srvs::Empty::Response &res)
{
    ...
    arcl_youbot_kinematics::JointVector torque;
...
bool ModuleDirectControl::stiffenCallback(std_srvs::Empty::Request &req, std_srvs::Empty::Response &res)
{
    ...
    arcl_youbot_kinematics::JointPosition pos = youbot_->arm()->getJointPosition();
...
void ModuleDirectControl::jointPositionCallback(const arcl_youbot_msgs::JointVector::ConstPtr pos)
{
    boost::mutex::scoped_lock lock(arm_mutex_);

    if(!arm_is_busy_)
    {
        arcl_youbot_kinematics::JointPosition jpos;
        jpos.setQ1(pos->q1);
        jpos.setQ2(pos->q2);
        jpos.setQ3(pos->q3);
        jpos.setQ4(pos->q4);
