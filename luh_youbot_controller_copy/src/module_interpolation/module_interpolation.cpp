...
bool ModuleInterpolation::setCartesianVelocityCallback(arcl_youbot_msgs::SetCartesianVelocity::Request &req,
...
bool ModuleInterpolation::setCylindricVelocityCallback(arcl_youbot_msgs::SetCylindricVelocity::Request &req,
...
bool ModuleInterpolation::setJointVelocityCallback(arcl_youbot_msgs::SetJointVelocity::Request &req,
...
void ModuleInterpolation::cartVelocityCallback(const arcl_youbot_msgs::CartesianVector::ConstPtr &msg)
{
    boost::mutex::scoped_lock lock(arm_mutex_);
...
void ModuleInterpolation::jntVelocityCallback(const arcl_youbot_msgs::JointVector::ConstPtr &msg)
{
    boost::mutex::scoped_lock lock(arm_mutex_);
...
void ModuleInterpolation::cylVelocityCallback(const arcl_youbot_msgs::CylindricVector::ConstPtr &msg)
{
    boost::mutex::scoped_lock lock(arm_mutex_);
...
void ModuleInterpolation::cartesianPoseCallback()
{
    ...
    boost::shared_ptr<const arcl_youbot_msgs::MoveToCartesianPoseGoal> goal = cartesian_pose_server_->acceptNewGoal();
...
void ModuleInterpolation::cylindricPoseCallback()
{
    ...
    boost::shared_ptr<const arcl_youbot_msgs::MoveToCylindricPoseGoal> goal = cylindric_pose_server_->acceptNewGoal();
...
void ModuleInterpolation::jointPoseCallback()
{
    ...
    boost::shared_ptr<const arcl_youbot_msgs::MoveToJointPoseGoal> goal = joint_pose_server_->acceptNewGoal();
...
void ModuleInterpolation::namedPoseCallback()
{
    ...
    boost::shared_ptr<const arcl_youbot_msgs::MoveToNamedPoseGoal> goal = named_pose_server_->acceptNewGoal();
    ...
    if(goal->interpolation_mode == arcl_youbot_msgs::JOINTSPACE)
    {
        coordinate_mode_ = JOINTSPACE;
        goal_position_ = joint_position;
    }
    if(goal->interpolation_mode == arcl_youbot_msgs::CYLINDRIC)
    {
        coordinate_mode_ = CYLINDRIC;
        goal_position_ = joint_position.toCylindric();
    }
    if(goal->interpolation_mode == arcl_youbot_msgs::CARTESIAN)
    {
        coordinate_mode_ = CARTESIAN;
