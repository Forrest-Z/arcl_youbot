...
public:
    ...
    arcl_youbot_kinematics::JointPosition getPositionError();

    /**
     * @brief Methode ruft die Initialisierung für eine neue Bahnplanung im Jointspace auf.
     */
    void newTrajectory(arcl_youbot_kinematics::JointPosition current_position);
    ...
    /**
      ...
      */
    void update(arcl_youbot_kinematics::JointPosition current_position);

    arcl_youbot_kinematics::JointPosition getPosition();
    arcl_youbot_kinematics::JointVelocity getVelocity();
    arcl_youbot_kinematics::JointAcceleration getAcceleration();
...
private:
    ...
    /**
      ...
      */
    void setcurrentJointPosition(arcl_youbot_kinematics::JointPosition current_position);
...
//    ros::NodeHandle n;
    ...
    //arcl_youbot_kinematics::JointVelocity currentVelocities;
    arcl_youbot_kinematics::JointVector armJointVelocities;
    arcl_youbot_kinematics::JointAcceleration armJointAccelerations;
    arcl_youbot_kinematics::JointPosition armJointPositions;
    ...
    //arcl_youbot_kinematics::JointPosition currentPositions;
    //arcl_youbot_kinematics::JointPosition regler;
