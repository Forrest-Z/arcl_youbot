...
public:
    ...
    arcl_youbot_kinematics::JointVector getEffort(arcl_youbot_kinematics::JointPosition joint_position,
                                                 arcl_youbot_kinematics::JointVelocity joint_velocity,
                                                 arcl_youbot_kinematics::JointAcceleration joint_acceleration);
