...
protected:
    ...
    {
        arcl_youbot_kinematics::JointPosition position;
        ros::Duration time;
    };
    ...
    arcl_youbot_kinematics::JointPosition actual_position_;
    arcl_youbot_kinematics::JointPosition desired_position_;
    arcl_youbot_kinematics::JointPosition position_error_;

    arcl_youbot_kinematics::JointPosition path_tolerance_;
    arcl_youbot_kinematics::JointPosition default_path_tolerance_;
    arcl_youbot_kinematics::JointPosition goal_tolerance_;
    arcl_youbot_kinematics::JointPosition default_goal_tolerance_;
