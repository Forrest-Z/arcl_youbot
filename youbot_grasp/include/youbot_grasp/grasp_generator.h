 ...
 */
  ...
  /*generate the grasp*/
  int generateGrasp(std::string object_file_name, std::vector<geometry_msgs::Point>& sample_point , std::vector<geometry_msgs::Point>& sample_normal , double , double, double, std::list<plannedGrasp*>& grasp_list, int gripper_type, youbot_grasp::PlanningScene * planning_scene, geometry_msgs::Pose target_pose, std::list<sampledPoint*> sampledPoint_list);
  ...
  static std::vector<fcl::Vec3f> vertices_L_;
  static std::vector<fcl::Triangle> triangles_L_;
  static std::vector<fcl::Vec3f> vertices_T_;
  static std::vector<fcl::Triangle> triangles_T_;
  static std::vector<fcl::Vec3f> vertices_cube_;
  static std::vector<fcl::Triangle> triangles_cube_;

  static std::vector<fcl::Vec3f> vertices_cube_1_;
  static std::vector<fcl::Triangle> triangles_cube_1_;
  static std::vector<fcl::Vec3f> vertices_cube_2_;
  static std::vector<fcl::Triangle> triangles_cube_2_;
