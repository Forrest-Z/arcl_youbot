...
class ApproachDirGenerator
{
  public:
    ...
    void generateApproachDir(std::string object_file_name, geometry_msgs::Pose target_pose, double, double, double, std::list<sampledPoint*> &sampledPoint_list, std::vector<geometry_msgs::Point>* sample_point = 0, std::vector<geometry_msgs::Point>* sample_normal = 0);
