...
*/
void ApproachDirGenerator::generateApproachDir(std::string object_file_name, geometry_msgs::Pose target_pose, double dx, double dy, double dz, std::list<sampledPoint*> &sampledPoint_list, std::vector<geometry_msgs::Point>* sample_point, std::vector<geometry_msgs::Point>* sample_normal)
{
  MyMesh m;
  int load_mask;
  ...
  float sample_scale;
  vcg::Point3f com;
  ROS_WARN_STREAM("GenerateApproachDir:"<< object_file_name);
  if(object_file_name == "cube"){
    
    std::vector<int> index_list;
    index_list.push_back(10);
    index_list.push_back(9);
    index_list.push_back(11);
    index_list.push_back(8);
    index_list.push_back(12);
    index_list.push_back(7);
    index_list.push_back(13);
    index_list.push_back(6);
    index_list.push_back(14);
    index_list.push_back(5);
    index_list.push_back(15);
    index_list.push_back(4);
    index_list.push_back(16);
    index_list.push_back(3);
    index_list.push_back(17);
    index_list.push_back(2);
    index_list.push_back(18);
    index_list.push_back(1);
    index_list.push_back(19);
    ...
    double x_min = -dx/2.0;
    double x_max = dx/2.0;
//dx = 0.025, double dy = 0.025, double dz = 0.15
// these sample point and dir are normal to the face
    for(int i = 1; i < 20; i++){
        double z_step = (z_max - z_min)/20.0;
        geometry_msgs::Point point;
        point.z = z_max - index_list[i-1]*z_step;
        point.y = 0;
        point.x = x_max;
...
//        sampledPoint_list.push_back(sp);
    ...
    for(int i = 1; i < 20; i++){
        double z_step = (z_max -z_min)/20.0;
        geometry_msgs::Point point;
        point.z = z_min + index_list[i-1]*z_step;
        point.y = 0;
        point.x = x_min;
        ROS_INFO_STREAM("sample_point:"<<point.x<<","<<point.y<<","<<point.z);
        geometry_msgs::Point normal;
...
// below sample point and their dir are not normal anymore
  ...
  }else if(object_file_name == "L_block"){
    std::vector<int> index_list;
    index_list.push_back(5);
    index_list.push_back(4);
    index_list.push_back(6);
...
// these sample point and dir are normal to the face
    ...
    sp = new sampledPoint(point, normal); 
    //sampledPoint_list.push_back(sp);
  }else if(object_file_name == "T_block"){
    std::vector<int> index_list;
    index_list.push_back(5);
    index_list.push_back(4);
    index_list.push_back(6);
...
// these sample point and dir are normal to the face
    ...
    for(int i = 1; i < 2; i++){
        double x_step = (x_max - x_min)/10.0;
        geometry_msgs::Point point;
        point.x = x_max - index_list[k-1]*x_step;
        point.y = 0;
        point.z = z_max;
        ROS_INFO_STREAM("sample_point:"<<point.x<<","<<point.y<<","<<point.z);       
        geometry_msgs::Point normal;
    ...
    for(int i = 1; i < 2; i++){
        double x_step = (x_max - x_min)/10.0;
        geometry_msgs::Point point;
        point.x = x_min + index_list[k-1]*x_step;
        point.y = 0;
        point.z = z_min;
        ROS_INFO_STREAM("sample_point:"<<point.x<<","<<point.y<<","<<point.z);
        geometry_msgs::Point normal;
...
// these sample point and dir are normal to the face
    for(int i = 1; i < 2; i++){
        double y_step = (y_max - y_min)/10.0;
        geometry_msgs::Point point;
        point.x = -0.0324;
        point.y = y_max - index_list[k-1]*y_step;
        point.z = z_max;
        ROS_INFO_STREAM("sample_point:"<<point.x<<","<<point.y<<","<<point.z);       
        geometry_msgs::Point normal;
        normal.x = 0;
    ...
    for(int i = 1; i < 2; i++){
        ...
        geometry_msgs::Point point;
        point.x = -0.0324;
        point.y = y_min + index_list[k-1]*y_step;
        point.z = z_min;
        ROS_INFO_STREAM("sample_point:"<<point.x<<","<<point.y<<","<<point.z);
        geometry_msgs::Point normal;
        normal.x = 0;
