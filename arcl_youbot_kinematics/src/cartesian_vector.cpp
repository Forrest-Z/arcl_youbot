...
namespace arcl_youbot_kinematics
{
...
// ######################## FROM ROS MESSAGE ###########################################################################
CartesianPosition CartesianPosition::fromMsg(const arcl_youbot_msgs::CartesianVector &pose_msg,
                                             bool is_relative,
...
CartesianVelocity CartesianVelocity::fromMsg(const arcl_youbot_msgs::CartesianVector &velocity_msg,
                                             const tf::TransformListener *tf_listener)
{
