...
public:
     ...
     */
    static CartesianPosition fromMsg(const arcl_youbot_msgs::CartesianVector &pose_msg,
...
public:
     ...
     */
    static CartesianVelocity fromMsg(const arcl_youbot_msgs::CartesianVector &velocity_msg,
                                     const tf::TransformListener *tf_listener);
};
