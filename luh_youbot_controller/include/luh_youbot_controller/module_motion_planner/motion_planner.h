...
#include "arcl_youbot_msgs/ToPredefinedPose.h"
#include "arcl_youbot_msgs/ListPoses.h"
...
typedef std::deque<arcl_youbot_kinematics::JointPosition> Path;
typedef actionlib::SimpleActionServer<arcl_youbot_msgs::MoveJointPathAction>     JointPathServer;
typedef actionlib::SimpleActionServer<arcl_youbot_msgs::MoveCartesianPathAction> CartesianPathServer;
typedef actionlib::SimpleActionServer<arcl_youbot_msgs::MoveCylindricPathAction> CylindricPathServer;
typedef actionlib::SimpleActionServer<arcl_youbot_msgs::MoveNamedPathAction>     NamedPathServer;
typedef actionlib::SimpleActionServer<arcl_youbot_msgs::MoveToCartesianPoseAction>     CartesianPoseServer;
typedef actionlib::SimpleActionServer<arcl_youbot_msgs::MoveToCylindricPoseAction>     CylindricPoseServer;
typedef actionlib::SimpleActionServer<arcl_youbot_msgs::MoveToJointPoseAction>         JointPoseServer;
typedef actionlib::SimpleActionServer<arcl_youbot_msgs::MoveToNamedPoseAction>         NamedPoseServer;
...
public:
    ...
    Path getPath(arcl_youbot_kinematics::JointPosition start, arcl_youbot_kinematics::JointPosition end);
    Pose* findClosestPose(arcl_youbot_kinematics::JointPosition pose);
...
//    ros::Publisher position_publisher_;
    ...
    arcl_youbot_kinematics::JointVelocity joint_velocities_;
...
//    std::vector<Pose> additional_poses_; /// additional poses that can be set as goals
    ...
    arcl_youbot_kinematics::JointPosition end_pose_;
    ...
    arcl_youbot_kinematics::JointVector joint_weights_;
    ...
    void resetPoses();
    void updateNeighborCosts(Pose* current_pose, arcl_youbot_kinematics::JointPosition end_position);
    void addNeighbors(PoseSet &open, Pose* current_pose);

    double costFunction(const arcl_youbot_kinematics::JointPosition &position, const Pose &pose);
    double costFunction(const Pose &pos1, const Pose &pos2);

    bool predefPoseCallback(arcl_youbot_msgs::ToPredefinedPose::Request &req,
                            arcl_youbot_msgs::ToPredefinedPose::Response &res);
    bool listPosesCallback(arcl_youbot_msgs::ListPoses::Request &req, arcl_youbot_msgs::ListPoses::Response &res);
