...
class VelocityController(object):
    ...
    def __init__(self, youbot_name):
        ...
        self.current_pos = get_youbot_base_pose2d(youbot_name)
        ...
        velocity_i_factor_x = rospy.get_param("module_base_controller/velocity_i_factor_x", 0.25)
        velocity_i_factor_y = rospy.get_param("module_base_controller/velocity_i_factor_y", 0.25)
        velocity_i_factor_theta = rospy.get_param("module_base_controller/velocity_i_factor_theta", 0.25)
        ...
        goal_reached_threshold_x = rospy.get_param("module_base_controller/goal_reached_threshold_x", 0.2)
        goal_reached_threshold_y = rospy.get_param("module_base_controller/goal_reached_threshold_y", 0.2)
        goal_reached_threshold_theta = rospy.get_param("module_base_controller/goal_reached_threshold_theta", 0.174533)
