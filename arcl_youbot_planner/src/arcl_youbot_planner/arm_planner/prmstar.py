...
class PRMStarPlanner():
    ...
    def check_pose_collision(self, pose):
        ...
        for self_contact in self_collision_list:
            if (self_contact[3] == 12 and self_contact[4] == 15) or (self_contact[3] == 12 and self_contact[4] == 14) or (self_contact[3] == 14 and self_contact[4] == 15) or (self_contact[3] == 15 and self_contact[4] == 0) or (self_contact[3] == 14 and self_contact[4] == 0) or (self_contact[3] == 12 and self_contact[4] == 0):
                pass
            else:
                print("self-collision:")
                print(self_contact)
