...
typedef actionlib::SimpleActionClient<arcl_youbot_msgs::MoveBaseAction> MoveBaseClient;
typedef actionlib::SimpleActionClient<arcl_youbot_msgs::ApproachBaseAction> ApproachClient;
...
protected:
    ...
    void onMoveBaseActionDone(const actionlib::SimpleClientGoalState& state,
                              const arcl_youbot_msgs::MoveBaseResultConstPtr& result);

    void onApproachActionDone(const actionlib::SimpleClientGoalState& state,
                              const arcl_youbot_msgs::ApproachBaseResultConstPtr& result);
