...
typedef actionlib::SimpleActionClient<arcl_youbot_msgs::GripObjectAction> GripObjectClient;
typedef actionlib::SimpleActionClient<arcl_youbot_msgs::SetGripperAction> SetGripperClient;
...
protected:
    ...
    void onSetGripperActionDone(const actionlib::SimpleClientGoalState& state,
                                const arcl_youbot_msgs::SetGripperResultConstPtr& result);
    void onGripObjectActionDone(const actionlib::SimpleClientGoalState& state,
                                const arcl_youbot_msgs::GripObjectResultConstPtr& result);
