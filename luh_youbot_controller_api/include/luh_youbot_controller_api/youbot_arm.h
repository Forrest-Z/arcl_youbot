...
#include <arcl_youbot_msgs/MoveJointPathAction.h>
#include <arcl_youbot_msgs/MoveCartesianPathAction.h>
#include <arcl_youbot_msgs/MoveCylindricPathAction.h>
#include <arcl_youbot_msgs/MoveNamedPathAction.h>
...
typedef actionlib::SimpleActionClient<arcl_youbot_msgs::MoveToCartesianPoseAction> CartesianPoseClient;
typedef actionlib::SimpleActionClient<arcl_youbot_msgs::MoveToCylindricPoseAction> CylindricPoseClient;
typedef actionlib::SimpleActionClient<arcl_youbot_msgs::MoveToJointPoseAction> JointPoseClient;
typedef actionlib::SimpleActionClient<arcl_youbot_msgs::MoveToNamedPoseAction> NamedPoseClient;
typedef actionlib::SimpleActionClient<arcl_youbot_msgs::MoveJointPathAction> JointPathClient;
typedef actionlib::SimpleActionClient<arcl_youbot_msgs::MoveCylindricPathAction> CylindricPathClient;
typedef actionlib::SimpleActionClient<arcl_youbot_msgs::MoveCartesianPathAction> CartesianPathClient;
typedef actionlib::SimpleActionClient<arcl_youbot_msgs::MoveNamedPathAction> NamedPathClient;
...
typedef std::vector<arcl_youbot_kinematics::JointPosition> JointPath;
/// Path in cylindrical coordinates
typedef std::vector<arcl_youbot_kinematics::CylindricPosition> CylindricPath;
/// Path in cartesian coordinates
typedef std::vector<arcl_youbot_kinematics::CartesianPosition> CartesianPath;
 ...
 * arcl_youbot_kinematics::CartesianPosition pos;
 * pos.setX(0.2);
 ...
 * arcl_youbot_kinematics::CylindricPosition relative_pos;
...
public:
     ...
     */
    void moveToPose(arcl_youbot_kinematics::JointPosition pose, int mode=MotionMode::PLAN,
     ...
     * @param pose_is_relative Specifies if the pose is relative to current pose or absolute.
     */
    void moveToPose(arcl_youbot_kinematics::CylindricPosition pose, int mode=MotionMode::PLAN,
                    bool pose_is_relative=false);
     ...
     * @param pose_is_relative Specifies if the pose is relative to current pose or absolute.
     */
    void moveToPose(arcl_youbot_kinematics::CartesianPosition pose, int mode=MotionMode::PLAN,
     ...
     */
    bool setMaxVelocity(arcl_youbot_kinematics::JointVelocity velocity);
     ...
     * @return Returns false if the values are invalid.
     */
    bool setMaxVelocity(arcl_youbot_kinematics::CartesianVelocity velocity);
     ...
     * @return Returns false if the values are invalid.
     */
    bool setMaxVelocity(arcl_youbot_kinematics::CylindricVelocity velocity);
...
protected:
    ...
    void onJointActionDone(const actionlib::SimpleClientGoalState& state,
                           const arcl_youbot_msgs::MoveToJointPoseResultConstPtr& result);
    void onCartActionDone(const actionlib::SimpleClientGoalState& state,
                          const arcl_youbot_msgs::MoveToCartesianPoseResultConstPtr& result);
    void onCylActionDone(const actionlib::SimpleClientGoalState& state,
                         const arcl_youbot_msgs::MoveToCylindricPoseResultConstPtr& result);
    void onNamedActionDone(const actionlib::SimpleClientGoalState& state,
                           const arcl_youbot_msgs::MoveToNamedPoseResultConstPtr& result);

    void onJointTrajActionDone(const actionlib::SimpleClientGoalState& state,
                           const arcl_youbot_msgs::MoveJointPathResultConstPtr& result);
    void onCartTrajActionDone(const actionlib::SimpleClientGoalState& state,
                          const arcl_youbot_msgs::MoveCartesianPathResultConstPtr& result);
    void onCylTrajActionDone(const actionlib::SimpleClientGoalState& state,
                         const arcl_youbot_msgs::MoveCylindricPathResultConstPtr& result);
    void onNamedTrajActionDone(const actionlib::SimpleClientGoalState& state,
                           const arcl_youbot_msgs::MoveNamedPathResultConstPtr& result);
