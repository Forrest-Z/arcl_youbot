...
#include <arcl_youbot_msgs/interpolation_mode.h>
...
void YoubotArm::init(ros::NodeHandle &node, bool async)
{
    ...
    set_cart_vel_client_ = node.serviceClient<arcl_youbot_msgs::SetCartesianVelocity>("arm_1/set_cartesian_velocity");
    set_cyl_vel_client_ = node.serviceClient<arcl_youbot_msgs::SetCylindricVelocity>("arm_1/set_cylindirc_velocity");
    set_jnt_vel_client_ = node.serviceClient<arcl_youbot_msgs::SetJointVelocity>("arm_1/set_joint_velocity");
...
void YoubotArm::moveToPose(arcl_youbot_kinematics::JointPosition pose, int mode, bool pose_is_relative)
{
    arcl_youbot_msgs::MoveToJointPoseGoal goal;
...
void YoubotArm::moveToPose(arcl_youbot_kinematics::CylindricPosition pose, int mode, bool pose_is_relative)
{
    arcl_youbot_msgs::MoveToCylindricPoseGoal goal;
    goal.pose_is_relative = pose_is_relative;
    goal.pose.q1 = pose.q1();
    goal.pose.r = pose.r();
    goal.pose.z = pose.z();
...
void YoubotArm::moveToPose(arcl_youbot_kinematics::CartesianPosition pose, int mode, std::string frame_id,
                           bool pose_is_relative)
{
    arcl_youbot_msgs::MoveToCartesianPoseGoal goal;
    goal.pose_is_relative = pose_is_relative;
...
{
    arcl_youbot_msgs::MoveToNamedPoseGoal goal;
    goal.pose_name = pose_name;

    if(interpolation_mode == InterpolationMode::JOINTSPACE)
        goal.interpolation_mode = arcl_youbot_msgs::JOINTSPACE;

    else if(interpolation_mode == InterpolationMode::CARTESIAN)
        goal.interpolation_mode = arcl_youbot_msgs::CARTESIAN;

    else if(interpolation_mode == InterpolationMode::CYLINDRIC)
        goal.interpolation_mode = arcl_youbot_msgs::CYLINDRIC;
...
{
    arcl_youbot_msgs::MoveJointPathGoal goal;
...
{
    arcl_youbot_msgs::MoveCylindricPathGoal goal;
    goal.path.poses.resize(path.size());
...
{
    arcl_youbot_msgs::MoveCartesianPathGoal goal;
    goal.path.poses.resize(path.size());
...
{
    arcl_youbot_msgs::MoveNamedPathGoal goal;
...
//########## SET MAX VELOCITY ##########################################################################################
bool YoubotArm::setMaxVelocity(arcl_youbot_kinematics::CartesianVelocity velocity)
{
    arcl_youbot_msgs::SetCartesianVelocity srv;
...
//########## SET MAX VELOCITY ##########################################################################################
bool YoubotArm::setMaxVelocity(arcl_youbot_kinematics::CylindricVelocity velocity)
{
    arcl_youbot_msgs::SetCylindricVelocity srv;
...
//########## SET MAX VELOCITY ##########################################################################################
bool YoubotArm::setMaxVelocity(arcl_youbot_kinematics::JointVelocity velocity)
{
    arcl_youbot_msgs::SetJointVelocity srv;
    srv.request.max_velocity.q1 = velocity.q1();
