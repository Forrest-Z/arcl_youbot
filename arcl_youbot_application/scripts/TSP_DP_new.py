...
class DP_solver(object):
    ...
    def dynamic_programming(self):
        ...
        for dy_num in range(1, self.n + 1):
            count = 0
            for set_iter in self.set_iterator(dy_num):
                count += 1
                print dy_num, self.n+1, count
                dy_group = Dynamic_Group(set_iter, self.objs, self.dy_group_dictionary, self.exit,self.overlapping_dict)
                ...
                self.dy_group_dictionary[set_iter] = [dy_group.cost, copy.deepcopy(dy_group.first_pick_subgroup), copy.deepcopy(dy_group.first_subgroup_path), dy_group.improved_cost, copy.deepcopy(dy_group.first_subgroup_path_improved), dy_group.obj_order]
